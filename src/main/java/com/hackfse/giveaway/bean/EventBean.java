...
public class EventBean {
	...
	public EventBean(Long id, String name, Date created_at, Date updated_at, Date startDate, Date endDate,
			String address, String city, String contactno, String contactName, String pic_url_1, String pic_url_2,
			String pic_url_3, String pic_url_4) {
		super();
		this.id = id;
		this.name = name;
		this.created_at = created_at;
